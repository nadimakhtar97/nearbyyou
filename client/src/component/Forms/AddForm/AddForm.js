...
import {Button, Heading, Container, Box, HStack, FormControl, FormLabel, Input, useToast} from "@chakra-ui/react";
...
const AddForm = (props) => {
    ...
    const onSubmit = values => {
        ...
        axios.post('/add', storeData).then((res) => {
                ...
                formik => {
                    return (
                        <Container>
                            <Form>
                                <Box m={3}>
                                    <Heading as='h2' size='md'>ADD STORE</Heading>
                                </Box>
